                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item ">
                            <a href="<?= base_url('C_menu') ?>" class="nav-link">
                                ...
                                <p>
                                    ...
                                    } else if ($this->session->userdata('tipe_akun') == '3') {
                                        echo 'Beranda Master';
                                    } ?>
                                </p>
                            </a>
                        ...
                        <?php if ($this->session->userdata('tipe_akun') == '3') { ?>
                            <li class="nav-item">
                                <a href="<?= base_url('C_nelayanMaster') ?>" class="nav-link">
                                    <i class="nav-icon fas fa-ship"></i>
                                    <p>
                                        <?php if ($this->session->userdata('tipe_akun') == '2') {
                                            echo 'Data Nelayan Super';
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('C_ikanMaster') ?>" class="nav-link">
                                    <i class="nav-icon fas fa-fish"> </i>
                                    <p>
                                        <p>
                                            <?php if ($this->session->userdata('tipe_akun') == '2') {
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link">
                                    <i class="nav-icon fas fa-user-circle"></i>
                                    <p><?php if ($this->session->userdata('tipe_akun') == '3') {
                                            echo 'Data Akun Master';
                                        } else if ($this->session->userdata('tipe_akun') == '1') {
                                            echo 'Laporan Admin';
                                        } else if ($this->session->userdata('tipe_akun') == '0') {
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('C_akunMaster') ?>" class="nav-link">
                                            <i class="nav-icon fas fa-user-circle"></i>
                                            <p>
                                                <p>
                                                    <?php if ($this->session->userdata('tipe_akun') == '2') {
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('C_akunMaster/alluser/') ?>" class="nav-link">
                                            <i class="nav-icon fas fa-user-circle"></i>
                                            <p>
                                                <p>
                                                    <?php if ($this->session->userdata('tipe_akun') == '2') {
                        ...
                        <?php if ($this->session->userdata('tipe_akun') <> '4' && $this->session->userdata('tipe_akun') != '3') {
                        ?>
                            <li class="nav-item">
                                <a href="#" class="nav-link">
