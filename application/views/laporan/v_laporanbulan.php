...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row mt-4">
                <div class="col">
                    <form action="<?= base_url('C_laporan/download_laporan_per_bulan'); ?>" class="form-inline">
                        <select onchange="select_date1()" name="select_month" class="form-control" id="select_month" required>
                            <option value="">Pilih Bulan dan Tahun</option>
                            <?php foreach ($select_bulan as $a) { ?>
                                <option value="<?= $a['select_month']; ?>"><?php echo $a['select_month']; ?></option>
                            <?php } ?>
                        </select>
                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Jumlah Penjualan Ikan Per Bulan</h3>
                    ...
                    <?php if ($this->session->userdata('tipe_akun') == '2') { ?>
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <form method="GET" action="<?= base_url('C_laporan/bulanan'); ?>">
                                        <div class="input-group input-group-sm" style="width: 150px;">
                                            <input type="text" name="table_search_bulan" class="form-control float-right" placeholder="Bulan">
