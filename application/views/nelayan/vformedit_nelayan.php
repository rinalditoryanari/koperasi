                        ...
                        <div class="col-sm-12">
                            <div class="content-header">
                                ...
                                <?php if ($this->session->userdata('tipe_akun')==3) : ?>
                                    <form method="post" action="<?= base_url('C_nelayanMaster/update') ?>"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="pelabuhan_bongkar" class="form-control"
                                                    ...
                                                    placeholder="Pelabuhan Bongkar" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-footer">
                                            <a href="<?= base_url('C_nelayanMaster')?>" class="btn btn-warning">Cancel</a>
