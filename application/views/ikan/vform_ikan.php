                    ...
                    <div class="card">
                        <div class="col-sm-12">
                            <div class="content-header">
                                ...
                                <?php echo form_open_multipart('C_ikan/tambah_ikan') ?>
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nama_ikan" class="form-control" id="nama_ikan"
                                                placeholder="Nama Ikan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="harga_ikan" class="form-control" id="harga_ikan"
                                                placeholder="Harga Ikan" required>
                                        </div>
                                    </div>
