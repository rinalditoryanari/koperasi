...
class C_nelayanMaster extends CI_Controller
{
    ...
    public function edit($id)
    {
        if ($this->session->userdata("akun_id") == "") {
            ...
            $isi['data'] = $this->M_nelayanMaster->edit($id);
            $isi['pilih_alat']   = $this->M_nelayanMaster->list_alat();
            $this->load->view('template/header');
            $this->load->view('template/vsidebar');
    ...
    public function update()
    {
        ...
        $query = $this->M_nelayanMaster->update($id, $data);
        if ($query = true) {
    ...
    {
        $a = $this->M_nelayanMaster->hapus_nelayan($id);
        redirect('C_nelayanMaster');
    }
