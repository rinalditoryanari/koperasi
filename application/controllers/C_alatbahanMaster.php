...
class C_alatbahanMaster extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('M_alatbahanMaster');
    }
    ...
    public function index()
    {
        if ($this->session->userdata("akun_id") == "") {
            ...
            $data['all_alatbahan']   = $this->M_alatbahanMaster->index();
    ...
    public function edit($id)
    {
        if ($this->session->userdata("akun_id") == "") {
            ...
            $isi['data'] = $this->M_alatbahanMaster->edit($id);
            $this->load->view('template/header');
            $this->load->view('template/vsidebar');
