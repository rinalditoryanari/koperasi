...
class M_laporan extends ci_Model
{
    ...
    public function index($code, $isall = true, $limit = null, $offset = null)
    {
    ...
    //Process:  SELECT data penjualan di table penjualan_header, penjualan_detail, ikan
    public function bulan($code, $isall = true, $limit = null, $offset = null)
    {
        if ($this->session->userdata('client_id')) {
            $ses_client = $this->session->userdata('client_id');
        } else {
    ...
    //Process:  SELECT data penjualan di table penjualan_header, penjualan_detail, ikan
    public function tahun($code, $isall = true, $limit = null, $offset = null)
    {
        if ($this->session->userdata('client_id')) {
            $ses_client = $this->session->userdata('client_id');
        } else {
    ...
    public function download_laporan_per_hari($select_date, $code)
    {
        $query = "  SELECT
                        a.`created_date` AS tanggal,
                        c.`nama_ikan`,
    ...
    public function chart_laporan_per_hari($select_date, $code)
    {
        $query = "  SELECT
                        c.`nama_ikan`,
                        SUM(b.`berat`) AS jumlah,
    ...
    public function chart_laporan_per_bulan($select_date, $code)
    {
        $query = "  SELECT
                        c.`nama_ikan`,
                        SUM(b.`berat`) AS jumlah,
    ...
    public function chart_laporan_per_tahun($select_date, $code)
    {
        $query = "  SELECT
                        c.`nama_ikan`,
                        SUM(b.`berat`) AS jumlah,
    ...
    public function download_perbekalan_per_hari($select_date, $code)
    {
    ...
    public function list_bulan_tersedia($code)
    {
        $query = "  SELECT
    ...
    public function list_tahun_tersedia($code)
    {
        $query = "  SELECT
    ...
    public function download_laporan_per_bulan($select_month, $code)
    {
        $query = "  SELECT
            a.created_date,
    ...
    public function download_laporan_per_tahun($select_year, $code)
    {
        $query = " SELECT
