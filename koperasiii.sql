...
-- Dumping structure for table koperasi.akun
CREATE TABLE IF NOT EXISTS `akun` (
  `akun_id` int(10) NOT NULL AUTO_INCREMENT,
  `username` varchar(100) NOT NULL,
  `password` varchar(100) NOT NULL,
  `code` varchar(50) NOT NULL,
  `code_koperasi` varchar(50) NOT NULL,
  `tipe` int(2) NOT NULL,
...
-- Dumping data for table koperasi.akun: ~15 rows (approximately)
/*!40000 ALTER TABLE `akun` DISABLE KEYS */;
INSERT IGNORE INTO `akun` (`akun_id`, `username`, `password`, `code`, `code_koperasi`, `tipe`, `id_nelayan`, `asal`) VALUES
	...
	(46, 'Koperasi Matraman', '12345678', 'SUPER10220001', '', 2, 0, 'Matraman');
/*!40000 ALTER TABLE `akun` ENABLE KEYS */;

-- Dumping structure for table koperasi.alat
...
-- Dumping data for table koperasi.alat: ~15 rows (approximately)
/*!40000 ALTER TABLE `alat` DISABLE KEYS */;
INSERT IGNORE INTO `alat` (`id_alat`, `nama`, `jenis`, `satuan`, `harga_per_unit`, `created_date`, `created_by`, `modified_date`, `modified_by`, `lokasi`) VALUES
...
-- Dumping structure for table koperasi.ikan
CREATE TABLE IF NOT EXISTS `ikan` (
  `id_ikan` int(10) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table koperasi.ikan: ~19 rows (approximately)
/*!40000 ALTER TABLE `ikan` DISABLE KEYS */;
INSERT IGNORE INTO `ikan` (`id_ikan`, `nama_ikan`, `harga_ikan`, `gambar`, `lokasi`, `code_koperasi`) VALUES
	...
	(40, 'ikanq', 12, NULL, NULL, 'SUPER10220001');
/*!40000 ALTER TABLE `ikan` ENABLE KEYS */;

-- Dumping structure for table koperasi.koperasi
...
-- Dumping data for table koperasi.koperasi: ~2 rows (approximately)
/*!40000 ALTER TABLE `koperasi` DISABLE KEYS */;
INSERT IGNORE INTO `koperasi` (`id`, `nama`, `code`, `ketua`, `alamat`, `kecamatan`, `kota`, `provinsi`) VALUES
	(3, 'adminkop', 'SUPER08220001', 'Raditttt', 'Jl cilincing', 'Cilincing', 'Kota Jakarta Utara', 'Dki Jakarta'),
	(42, 'Koperasi Matraman', 'SUPER10220001', 'Bu Mera', 'Jalan jalan kuy', 'Matraman', 'Kota Jakarta Timur', 'Dki Jakarta'),
...
-- Dumping structure for table koperasi.nelayan
CREATE TABLE IF NOT EXISTS `nelayan` (
  ...
  `id_koperasi` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id` (`id`),
  KEY `id_alat` (`id_alat`),
  CONSTRAINT `fk_alat` FOREIGN KEY (`id_alat`) REFERENCES `alat` (`id_alat`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table koperasi.nelayan: ~8 rows (approximately)
/*!40000 ALTER TABLE `nelayan` DISABLE KEYS */;
INSERT IGNORE INTO `nelayan` (`id`, `nama`, `nama_kapal`, `jenis_kapal`, `id_alat`, `GT`, `daerah_tangkap`, `tanda_pas`, `pelabuhan_bongkar`, `keterangan`, `status`, `id_koperasi`) VALUES
	(6, 'Hendiyanto', 'ALPIN / CARIWAN', 'NELAYAN', 1, '6 GT', 'TELUK JAKARTA dan KARAWANG', '-', 'CILINCING', '-', 1, NULL),
	(7, 'ROFIUDIN', 'DEWI JAYA 5', 'NELAYAN', 3, '2 GT', 'TELUK JAKARTA dan KARAWANG', 'DK1 NO.31', 'CILINCING', '-', 1, NULL),
	(8, 'SUEB', 'LANGGENG JAYA 11', 'NELAYAN', 3, '3 GT', 'TELUK JAKARTA dan KARAWANG', 'DKI 3 NO.14', 'CILINCING', '-', 1, NULL),
	(9, 'CASMADI', 'ADELIA PUTRI ', 'NELAYAN', 4, '3 GT', 'TELUK JAKARTA dan KARAWANG', 'DKI 3 NO.79', 'CILINCING', '-', 1, NULL),
	(23, 'JUNAEDI', 'HEART OF THE SEA', 'TONGKANG', 1, '3 GT', 'TELUK JAKARTA dan KARAWANG', 'DKI 3 NO.79', 'CILINCING', '', 1, NULL),
	(27, 'AHMAD', 'TITANIC', 'TONGKANG', 1, '3 GT', 'SELAT SUNDA', 'DKI 4 NO 21', 'Penjaringan', '', 1, NULL),
	(28, 'BOAZ', 'CONQUEROR OF SEAS', 'TONGKANG', 6, '3 GT', 'SELAT SUNDA', 'DKI 4 NO 21', 'Penjaringan', '', 1, NULL),
	(40, 'Matraman', 'Matraman', 'Matraman', 1, '2', 'Matraman', 'Matraman', 'Matraman', 'Matramai', 1, 'SUPER10220001');
/*!40000 ALTER TABLE `nelayan` ENABLE KEYS */;

-- Dumping structure for table koperasi.peminjaman_detail
CREATE TABLE IF NOT EXISTS `peminjaman_detail` (
  `id_peminjaman_detail` int(5) NOT NULL AUTO_INCREMENT,
  ...
  KEY `id_peminjaman_header` (`id_peminjaman_header`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table koperasi.peminjaman_detail: ~35 rows (approximately)
/*!40000 ALTER TABLE `peminjaman_detail` DISABLE KEYS */;
INSERT IGNORE INTO `peminjaman_detail` (`id_peminjaman_detail`, `id_peminjaman_header`, `lokasi`, `id_alat`, `jumlah_pinjam`, `harga/unit_kembali`, `jumlah_kembali`, `harga/unit_pinjam`, `status`, `created_date`, `created_by`, `modified_date`, `modified_by`) VALUES
...
-- Dumping structure for table koperasi.peminjaman_header
CREATE TABLE IF NOT EXISTS `peminjaman_header` (
  `id_peminjaman_header` int(5) NOT NULL AUTO_INCREMENT,
  `id_nelayan` int(5) NOT NULL,
  `lokasi` varchar(20) NOT NULL,
  ...
  `modified_date` date DEFAULT NULL,
  `modified_by` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_peminjaman_header`),
  KEY `id_peminjaman_header` (`id_peminjaman_header`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table koperasi.peminjaman_header: ~29 rows (approximately)
/*!40000 ALTER TABLE `peminjaman_header` DISABLE KEYS */;
INSERT IGNORE INTO `peminjaman_header` (`id_peminjaman_header`, `id_nelayan`, `lokasi`, `code`, `total_pinjam`, `total_kembali`, `status`, `total`, `created_date`, `created_by`, `modified_date`, `modified_by`) VALUES
...
-- Dumping structure for table koperasi.penjualan_detail
CREATE TABLE IF NOT EXISTS `penjualan_detail` (
  `id_penjualan_detail` int(20) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table koperasi.penjualan_detail: ~53 rows (approximately)
/*!40000 ALTER TABLE `penjualan_detail` DISABLE KEYS */;
INSERT IGNORE INTO `penjualan_detail` (`id_penjualan_detail`, `id_penjualan`, `id_ikan`, `berat`, `harga/kg`, `created_date`, `created_by`, `modified_date`, `modified_by`) VALUES
...
-- Dumping structure for table koperasi.penjualan_header
CREATE TABLE IF NOT EXISTS `penjualan_header` (
  `id_penjualan_header` int(20) NOT NULL AUTO_INCREMENT,
  ...
  `modified_by` varchar(50) NOT NULL,
  `lokasi` varchar(20) NOT NULL,
  PRIMARY KEY (`id_penjualan_header`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table koperasi.penjualan_header: ~27 rows (approximately)
/*!40000 ALTER TABLE `penjualan_header` DISABLE KEYS */;
INSERT IGNORE INTO `penjualan_header` (`id_penjualan_header`, `id_nelayan`, `code`, `total`, `created_date`, `created_by`, `modified_date`, `modified_by`, `lokasi`) VALUES
