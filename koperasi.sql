...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2022 at 03:00 PM
...
INSERT INTO `koperasi` (`id`, `nama`, `kecamatan`, `alamat`, `ketua`) VALUES
(2, 'koperasi2', 'ANGKE', 'jalan jalan', 'ketua1'),
(1, 'koperasi1', 'CILINCING', 'Jalan jalan', 'ketua1');
...
--
ALTER TABLE `akun`
  MODIFY `akun_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `peminjaman_detail`
  MODIFY `id_peminjaman_detail` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `peminjaman_header`
--
ALTER TABLE `peminjaman_header`
  MODIFY `id_peminjaman_header` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
